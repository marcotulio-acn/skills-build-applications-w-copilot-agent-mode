          ...
          <div className="container mt-4">
            <div className="card shadow">
              <div className="card-body text-center">
                ...
                <p className="lead">Select a section from the menu to view activities, teams, users, leaderboard, or workouts.</p>
                ...
                <Link to="/users" className="btn btn-warning m-2">View Users</Link>
